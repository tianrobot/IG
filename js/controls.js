// Key constants
const K_FORWARD = '8'.charCodeAt(0);
const K_BACKWARD = '5'.charCodeAt(0);
const K_STRAFE_LEFT = '4'.charCodeAt(0);
const K_STRAFE_RIGHT = '6'.charCodeAt(0);
